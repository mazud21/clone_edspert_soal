import 'package:clone_edspert_soal/view/main/latihan_soal/paket_soal_page.dart';
...
import '../../../controller_provider/load_data.dart';
                  ...
                  loadData?.bannerList == null
                      ...
                      : Container(
                          ...
                          child: ListView.builder(
                            itemCount: loadData?.bannerList!.data!.length,
                            scrollDirection: Axis.horizontal,
                            itemBuilder: ((context, index) {
                              final currentBanner = loadData?.bannerList!.data![index];
                              return Padding(
        ...
        children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return MapelPage(mapel: loadData?.mapelList! as MapelList);
                  }));
                },
                child: Text(
                  "Lihat Semua",
          ...
          loadData?.mapelList == null
              ...
              : ListView.builder(
                  ...
                  itemCount: loadData?.mapelList?.data!.length as int > 4 ? 4 : loadData?.mapelList?.data!.length,
                  itemBuilder: (BuildContext context, int index) {
                    final currentMapel = loadData?.mapelList?.data![index];
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                PakeSoalPage(id: currentMapel?.courseId! as String),
                          ),
                        );
                      },
                      child: MapelWidget(
                        title: currentMapel?.courseName! as String,
